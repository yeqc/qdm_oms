...
Ext.onReady(function() {
	...
	TicketInfo= function() {
				...
				return {
					 ...
					 var isTimingSelectOption = new Ext.form.ComboBox( {
						...
						tbar = [{
						    ...
						    ,{ 
							    ...
							    },'<a style="color:red" href = "'+ basePath + '/custom/fileUpload/fileDownloadCsv.spmvc?filePath=add.csv' + '">模板下载</a>'
						    ];
					...
					doAfter : function(data){//上传后的数据返回
						...
						var json = Ext.util.JSON.decode(data);
                             ...
                             parent.ChannelShopGoodsAddVo.refresh();
			...
			function upload (){ //导入excel以后就与调整单绑定传入数据库保存
				...
				FormEditWin.showAddDirWin(null,basePath+"/fileUpload.html?uploadUrl="+basePath+"custom/shopGoodsAdd/inportChannelGoodsAdd.spmvc"+params,"picADWinID","上传",480,300);
			}

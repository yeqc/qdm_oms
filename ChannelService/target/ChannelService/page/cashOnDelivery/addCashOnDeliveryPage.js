...
Ext.onReady(function() {
	...
	TicketInfo= function() {
					 ...
					 var isTimingSelectOption = new Ext.form.ComboBox( {
						...
						tbar = [{
						    ...
						    ,{ 
							    ...
							    },'<a style="color:red" href = "'+ basePath + '/custom/fileUpload/fileDownloadCsv.spmvc?filePath=cashOnDelivery.csv' + '">模板下载</a>'
						    ];
			...
			function upload (){ //导入excel以后就与调整单绑定传入数据库保存
				...
				FormEditWin.showAddDirWin(null,basePath+"/fileUpload.html?uploadUrl="+basePath+"custom/ticketInfo/inportCashOnDeliveryChannelGoods.spmvc"+params,"picADWinID","上传",480,300);
			}

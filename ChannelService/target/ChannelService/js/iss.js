...
FormEditWin = function(){
	...
	return {
		...
		showAddDirWin:function(parentNode,url,winID,title,widthV,heightV){
			...
			cnode=parentNode;
			//alert(parentNode);
			//alert(ConTree.returnCurrNode+'33');
			win.show();
		},
		...
		newWin:function(url,winID,title,widthV,heightV){
			var wins=this.createWin(winID,title,url,function(){
			 }
			,widthV,heightV);
			wins.show();
		},
		newWinS:function(url,winID,title,widthV,heightV){
			var wins=this.createWinS(winID,title,url,function(){
			 }
			,widthV,heightV);
			wins.show();
		},
...
//栏目权限对象
Permission = function(channleId, lookable, updateble, delable, 
					insertable, publishable, setpermissionable, lookableContent,
					 updatebleContent, delableContent, insertableContent, publishableContent, setpermissionableContent){
	 ...
	 this.setpermissionable = setpermissionable;
	 this.lookableContent = lookableContent;
     this.updatebleContent = updatebleContent;
	 this.delableContent = delableContent;
	 this.insertableContent = insertableContent;
	 this.publishableContent = publishableContent;
	 this.setpermissionableContent = setpermissionableContent;
};

//模板权限对象
Tpermission = function(templetId, lookable, updateble, delable, 
					insertable, setpermissionable){

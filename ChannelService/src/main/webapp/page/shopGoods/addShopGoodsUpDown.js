...
Ext.onReady(function() {
	...
	TicketInfo= function() {
				...
				return {
					init : function() {
					 ...
					 var typeOptionCombo = new Ext.form.ComboBox( {
							id : 'channelGoodsTicket.ticketType',
							...
							blankText : '请选择调整类型',
							emptyText : '请选择调整类型',
							name : 'channelGoodsTicket.ticketType',
							editable : false,
							hiddenName : 'channelGoodsTicket.ticketType',
							triggerAction : 'all', 
							fieldLabel : '调整类型',
							width : 150
						});
					 ...
					 var isTimingSelectOption = new Ext.form.ComboBox( {
						...
						tbar = [{
						    ...
						    ,{ 
							    ...
							    },'<a style="color:red" href = "'+ basePath + '/custom/fileUpload/fileDownloadCsv.spmvc?filePath=updown.csv' + '">模板下载</a>'
						    ];
			...
			function upload (){ //导入excel以后就与调整单绑定传入数据库保存
				...
				FormEditWin.showAddDirWin(null,basePath+"/fileUpload.html?uploadUrl="+basePath+"custom/ticketInfo/inportChannelGoods.spmvc"+params,"picADWinID","上传",480,300);
			}

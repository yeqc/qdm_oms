...
//				Ext.getCmp('channelTemplate.editTemplateContent').setValue(encodeURI(editHtml));
				...
				if(arr != null && arr.length > 0) {
					...
					template = "<div class='gridly' style='width: 600px;position: relative;font-family: Tahoma, Geneva, sans-serif; font-size: 12px; overflow: hidden;'>\n";
					editTemplate = '';
					for (var i=0;i<tempArr.length;i++) {
						...
						j = i + 1;
						if (tempArr.length==1) {
							moduleTemplate += '[{"templateCode":"'+code+'","orderNum":'+j+',"moduleContent":"'+module+'","moduleId":'+moduleIdArr[i]+'}]';

...
<body>
		...
		<div style="width: 60%; float: left;">
			...
			<div class='content'>
				<section class='example'>
					<div   class='gridly' style="width: 790px;z-index: 800;position: relative;font-family: Tahoma, Geneva, sans-serif; font-size: 12px; overflow: hidden;">
					</div>
				</section>
			</div>
		</div>
	...
	<script type="text/javascript" src="<%=basePath%>/page/template/addTemplate.js"></script>
	<!-- 

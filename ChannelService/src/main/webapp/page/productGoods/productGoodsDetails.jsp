...
<%
 ...
 %>
<div id='productGoodsDetails-grid'></div>
<div id="productGoodsDetails-img" class="x-panel-mr">
			    ...
			    <tr>
			        <td>
			        	 <a target="_blank" href="${element.imgUrl}" >
					    	<img  src="${element.channelGoodsUrl}"  />
					    </a>
...
<script type="text/javascript"
	src="<%=basePath%>/page/productGoods/productGoodsDetails.js">
</script>
<script type="text/javascript"

...
Ext.Desktop = function(app) {
	...
	var wetherEl = Ext.get('x-wether');
    var desktopEl = Ext.get('x-desktop');
    var taskbarEl = Ext.get('ux-taskbar');
    var shortcuts = Ext.get('x-commcon');
        ...
        function(e, t) {
            ...
            if (t) {
                ...
                if (id == "grid-win") {
	                ...
	                if (module) {
	               		module.createWindow(t.getAttribute('name'), t.getAttribute('title'), t.getAttribute('url'));
	                }*/
	                ShortCut(t.getAttribute('name'), t.getAttribute('title'), t.getAttribute('url'));
                } else if (id == "tab-win") {
                	CreateTab(t.getAttribute('name'), t.getAttribute('title'), t.getAttribute('url'));
                } else if (id == "tree-win") {
                	var win = showWindow(t.getAttribute('name'),t.getAttribute('title'), t.getAttribute('url'));
                	win.show();
                }
            }
        });

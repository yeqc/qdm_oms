...
@Controller
@RequestMapping(value= "shopGoodsXinpin")
public class ShopGoodsXinpinController extends BaseController {
	 ...
	 * @return
	 */
	@RequestMapping(value= "shopGoodsXinpinPage.spmvc")
	public ModelAndView shopGoodsXinpinPage(){		
		ModelAndView mav = new ModelAndView();
		mav.setViewName("shopGoodsXinpin/shopGoodsXinpin");
		return mav;
	}
	 ...
	 * @return mav;
	 */
	@RequestMapping(value= "addshopGoodsXinpinPage.spmvc")
	public ModelAndView addshopGoodsXinpinPage(){		
		ModelAndView mav = new ModelAndView();
		ChannelGoodsTicketVo  addNewCgtVo = new ChannelGoodsTicketVo();
		String ticketCode = "XP"+StringUtil.getSysCode();
		addNewCgtVo.setTicketCode(ticketCode);//新增调整单的编号系统生成
	//	addNewCgtVo.setShopCode("1"); //新增调整单的店铺
		mav.addObject("addNewCgtVo",addNewCgtVo);
		mav.setViewName("shopGoodsXinpin/addshopGoodsXinpin");
		return mav;
	}
	...
	@RequestMapping(value= "shopGoodsXinpin.spmvc")
	public void shopGoodsXinpin(HttpServletRequest request,HttpServletResponse response,
	...
	//点击:查看/更新按钮
	@RequestMapping(value= "updateOrSearchXinpinTicketInfo.spmvc")
	public ModelAndView updateOrSearchXinpinTicketInfo(@ModelAttribute("id") String id){			
		ModelAndView mav = new ModelAndView();
	 ...
	 //店铺商品新品状态管理：批量商品导入--读取excel.csv  调整单生成
    @RequestMapping(value= "inportXinpinChannelGoods.spmvc", headers = "content-type=multipart/*")
    public void inportXinpinChannelGoods(@RequestParam MultipartFile myfile,@ModelAttribute("ticketCode") String ticketCode,HttpServletRequest request,HttpServletResponse response,
    	...
    	try {
			...
			if(list != null){
				...
				if("".equals(sb.toString())){ 
					...
					channelGoodsTicket.setTicketType((byte)11);

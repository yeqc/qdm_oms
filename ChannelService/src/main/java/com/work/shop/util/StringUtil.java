...
import com.banggo.common.Constant;
...
public class StringUtil extends StringUtils{
	...
	public synchronized static String getSysCode(){
		String str = "";
			code +=1;
			if(code>0 && code<10){
				str="000"+code;
		...
		if (isNotNull(str)) {str = TimeUtil.format3Date(new Date()) + str;}
		return str;
	}
...
//			  System.out.println("delim:"+delim);
	...
	public static boolean isTaoBaoChannel(String channelCode){
		if(Constants.TB_CHANNEL_CODE.equals(channelCode)
				||Constants.TMALL_CHANNEL_CODE.equals(channelCode)
				||Constants.TBFX_CHANNEL_CODE.equals(channelCode)){
			return true;
		}
		return false;
	}

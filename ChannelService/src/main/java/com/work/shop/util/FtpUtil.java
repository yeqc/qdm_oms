...
public class FtpUtil {
	...
	private static final String url = PropertieFileReader.getString("ftp_url");
	private static final int port = Integer.valueOf(PropertieFileReader.getString("ftp_port"));
	private static final String username = PropertieFileReader.getString("ftp_username");
	private static final String password = PropertieFileReader.getString("ftp_password");
	...
	public static List<String> getFileNameListByPath(String ftpPath){
		FTPClient ftp = new FTPClient();
		...
		try{
			...
			log.error("获取指定文件夹下所有文件失败！" + ExceptionStackTraceUtil.getExceptionTrace(e));
		}
		return fileNameList;
	}
}
